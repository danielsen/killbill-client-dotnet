...
namespace KillBillClient.Core.Models
{
    public class BlockingState : KillBillObject
    {
        ...
        {
            return
                $"BlockingState{{blockedId={BlockedId}, stateName='{StateName}', service='{Service}', blockChange={BlockChange}, blockEntitlement={BlockEntitlement}, blockBilling={BlockBilling}, effectiveDate={EffectiveDate}, type={Type}}}";
        }
    }
}